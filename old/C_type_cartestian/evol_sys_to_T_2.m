function [h_curr, u_curr, v_curr, err] = ...
    ...
    [u_curr, v_curr, h_curr] = step_fwd(derivative_fun, g, H, u_prev, v_prev, h_prev, dx, dy, dt);
    if(draw_th)
    ...
    for i_t = 2:Nt
        [u_prev, v_prev, h_prev] = ...
            step_center(derivative_fun, g, H, u_prev, v_prev, h_prev,...
                          u_curr, v_curr, h_curr, dx, dy, dt);
        
        [u_curr, v_curr, h_curr, u_prev, v_prev, h_prev] = ...
             deal(u_prev, v_prev, h_prev, u_curr, v_curr, h_curr);
